...
type
  ...
  {$ENDIF RTL230_UP}
  TACBrBoletoFCFortesA5 = class(TACBrBoletoFCClass)
  private
  ...
  TACBrBoletoFCFortesFr = class(TForm)
    ...
    RLLabel372: TRLLabel;
    txtDtDoc1CA5: TRLLabel;
    RLLabel337: TRLLabel;
    txtNumDoc1CA5: TRLLabel;
    RLLabel339: TRLLabel;
    txtEspecDoc1CA5: TRLLabel;
    RLLabel340: TRLLabel;
    txtAceite1CA5: TRLLabel;
    RLLabel341: TRLLabel;
    txtDtProc1CA5: TRLLabel;
    txtUsoBanco1CA5: TRLLabel;
    RLLabel383: TRLLabel;
    txtCarteira1CA5: TRLLabel;
    RLLabel342: TRLLabel;
    RLLabel386: TRLLabel;
    txtEspec1CA5: TRLLabel;
    RLLabel343: TRLLabel;
    txtQtd1CA5: TRLLabel;
    RLLabel390: TRLLabel;
    txtValor1CA5: TRLLabel;
    RLLabel345: TRLLabel;
    txtVenc1CA5: TRLLabel;
    RLLabel346: TRLLabel;
    txtAgCedente1CA5: TRLLabel;
    RLLabel396: TRLLabel;
    RLLabel347: TRLLabel;
    ...
    txtCPF1CA5: TRLLabel;
    RLLabel348: TRLLabel;
    txtCodBaixa1CA5: TRLLabel;
    RLLabel413: TRLLabel;
    linhaDigitavel1CA5: TRLLabel;
    txtDesc1CA5: TRLLabel;
    txtJuros1CA5: TRLLabel;
    txtOutros2CA5: TRLLabel;
    ...
    txtAcrescimo2CA5: TRLLabel;
    txtEnderecoPagador1CA5: TRLMemo;
    RLDraw312: TRLDraw;
    RLLabel463: TRLLabel;
    RLLabel350: TRLLabel;
    txtParcTotCA5: TRLLabel;
    txtParc1CA5: TRLLabel;
    RLDraw313: TRLDraw;
    RLLabel404: TRLLabel;
    RLLabel352: TRLLabel;
    RLLabel354: TRLLabel;
  ...
  public
    ...
    property BoletoFC : TACBrBoletoFCFortesA5 read fBoletoFC ;
...
constructor TACBrBoletoFCFortesA5.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

procedure TACBrBoletoFCFortesA5.Imprimir;
begin
  inherited Imprimir;    // Executa verificações padroes
  ImprimirInternal(nil);
end;

procedure TACBrBoletoFCFortesA5.Imprimir(AStream: TStream);
begin
...
procedure TACBrBoletoFCFortesA5.ImprimirInternal(AStream: TStream);
var
...
begin
  ...
  try
     ...
     begin
        case LayOut of
           lCarne       : RLLayout := LayoutCarneA5;
           lReciboTopo  : RLLayout := LayoutCarneA5;
           lFaturaDetal : RLLayout := LayoutCarneA5;
           lTermica80mm : RLLayout := LayoutCarneA5;
           lPrestaServicos : RLLayout := LayoutCarneA5;
        else
           RLLayout:= LayoutCarneA5;
        end;
...
begin
   fIndice   := 0 ;
   fBoletoFC := TACBrBoletoFCFortesA5(Owner) ;  // Link para o Pai
...
procedure TACBrBoletoFCFortesFr.RLBand11BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
Var
...
begin
   ...
   begin
      ...
      txtAgCedente1CA5.Caption        := CodCedente;
      ...
      txtAceite1CA5.Caption           := ifThen(Titulo.Aceite = atSim,'S','N');
      txtAceite2CA5.Caption           := ifThen(Titulo.Aceite = atSim,'S','N');

      txtDtProc1CA5.Caption           := IfThen(Titulo.DataProcessamento = 0,
                                                FormatDateTime('dd/mm/yyyy',Now),
                                                FormatDateTime('dd/mm/yyyy',Titulo.DataProcessamento));

      txtDtProc2CA5.Caption           := txtDtProc1CA5.Caption;
